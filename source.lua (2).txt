...
local library = {
	...
	colors = {
   	...
   	innerBorder = Color3.fromRGB(50, 50, 50),
   	topGradient = Color3.fromRGB(30, 30, 30),
   	bottomGradient = Color3.fromRGB(20, 20, 20),
   	sectionBackground = Color3.fromRGB(35, 35, 35),
   	section = Color3.fromRGB(200, 200, 200),
   	otherElementText = Color3.fromRGB(150, 150, 150),
   	elementText = Color3.fromRGB(175, 175, 175),
   	elementBorder = Color3.fromRGB(15, 15, 15),
   	selectedOption = Color3.fromRGB(45, 45, 45),
   	unselectedOption = Color3.fromRGB(30, 30, 30),
   	hoveredOptionTop = Color3.fromRGB(55, 55, 55),
   	unhoveredOptionTop = Color3.fromRGB(40, 40, 40),
   	hoveredOptionBottom = Color3.fromRGB(35, 35, 35),
   	unhoveredOptionBottom = Color3.fromRGB(25, 25, 25),
...
local keyHandler = {
	...
	notAllowedMouseInputs = {
		[ Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ] = true,
